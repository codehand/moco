...
import 'package:moco/screen/home/widget/vertical_scroll_offer.dart';
...
class OfferScreenState extends State<OfferScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: Get.find<OfferController>().getOfferList(1, false),
          ...
          return Container(
            child: Scaffold( 
              ...
              body: SafeArea(child: RefreshIndicator(
                onRefresh: () async { 
                  await Get.find<OfferController>().getOfferList(1, true);
                },
                              ...
                              child: SizedBox(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    VerticalScrollOfferView(offers: offerController.offers),
                                  ],
                                ),
                              ),
                            ),

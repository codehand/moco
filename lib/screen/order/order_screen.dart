...
import 'package:moco/screen/home/widget/order_list_widget.dart';
...
class OrderScreenState extends State<OrderScreen> {
  late Future<void> _fetchOrderData;

  @override
  void initState() {
    super.initState();
    _fetchOrderData = Get.find<OrderController>().getOrderList(1, false);
  }
          ...
          return Container(
            child: Scaffold( 
              ...
              body: SafeArea(child: RefreshIndicator(
                onRefresh: () async { 
                  await Get.find<OrderController>().getOrderList(1, true);
                },
                child: GestureDetector(
                  child: GetBuilder<OrderController>(
                    // initState: (state) {
                    //   Get.find<OrderController>().getOrderList(1, false);
                    // },
                              ...
                              child: SizedBox(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    OrderListView(orders: orderController.orders),
                                  ],
                                ),
                              ),
                            ),
